...
impl Literal {
    fn collect_nested(&self, mut w: &mut dyn Write, t: &mut Collector, depth: usize) -> fmt::Result {
        match *self {
            ...
            Literal::Char(v) => w.write_str(itoa::Buffer::new().format(v)),
            Literal::Int2(v) => w.write_str(itoa::Buffer::new().format(v)),
            Literal::Int4(v) => w.write_str(itoa::Buffer::new().format(v)),
            Literal::Int8(v) => w.write_str(itoa::Buffer::new().format(v)),
